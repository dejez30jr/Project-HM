...
<!-- Left Column: Content -->
<div class="flex flex-col w-full gap-6 items-start">
<h1 class="text-[2rem] md:text-[3.5rem] leading-[2.5rem] md:leading-[4.70rem] font-extrabold tracking-tight lg:max-w-md"">
                        {{ __('Agency SPG & Event Organizer') }} <br class="hidden md:block"/> {{ __('Terbaik di Indonesia') }}
                </h1>
<p class="font-body-lg text-body-lg text-on-surface-variant max-w-xl">
                        {{ __('kami hadir untuk memenuhi kebutuhan perusahaan anda baik dari segi Jasa Penyedia Manpower, pengadaan barang, produksi property event. decoration, baik untuk promosi maupun entertainment.') }}
                </p>
...
<div class="absolute top-4 right-4 flex flex-col gap-2">
  ...
  <section data-aos="fade-up" class="w-full mt-12">
    ...
    <div class="flex flex-col md:flex-row md:flex-wrap md:gap-x-20 gap-y-10">
      ...
      <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1a1a1a] md:w-1/3 leading-tight">
        {{ __('Kenapa anda Memilih kami?') }}
      </h2>
      <div class="md:max-w-[500px] text-gray-600">
      <p>{{ __('kami mengutamakan kualitas, kepercayaan, dan kepuasan Anda di setiap layanan yang kami berikan.') }}</p>
      </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10">
        ...
        <div class="flex space-x-4 shadow-md p-4">
          ...
          <div>
            <h3 class="sm:text-2xl font-bold text-sm leading-snug text-[#1a1a1a]">
              {{ __('Sumber Daya Manusia yang Berkualitas dan Teruji') }}
            </h3>
            <p class="text-xs leading-relaxed text-[#1a1a1a] mt-1 font-sans">
              {{ __('Sumber daya manusia berkualitas adalah kunci kemajuan; teruji melalui kompetensi, etika, dan pengalaman.') }}
          </div>
        </div>
        ...
        <div class="flex space-x-4  shadow-md p-4">
          ...
          <div>
            <h3 class="sm:text-2xl font-bold leading-snug text-[#1a1a1a]">
              {{ __('Internal Team yang sudah Expert dengan Bidangnya') }}
            </h3>
            <p class="text-xs leading-relaxed text-[#1a1a1a] mt-1 font-sans">
            {{ __('Tim internal yang expert menjamin efisiensi, kualitas kerja tinggi, dan solusi tepat sasaran.') }}
            </p>
          </div>
        </div>
        ...
        <div class="flex space-x-4  shadow-md p-4">
          ...
          <div>
            <h3 class="sm:text-2xl font-bold text-sm leading-snug text-[#1a1a1a]">
              {{ __('Area Coverage skala Nasional di Kota Kota Besar di Indonesia') }}
            </h3>
            <p class="text-xs leading-relaxed text-[#1a1a1a] mt-1 font-sans">
             {{ __('Area coverage nasional menjangkau kota-kota besar Indonesia, memastikan layanan luas dan optimal.') }}
            </p>
          </div>
        </div>
        ...
        <div class="flex space-x-4  shadow-md p-4">
          ...
          <div>
            <h3 class="sm:text-2xl font-bold text-sm leading-snug text-[#1a1a1a]">
              {{ __('Memiliki Resource Team hampir disetiap Kota Kota Besar') }}
            </h3>
            <p class="text-xs leading-relaxed text-[#1a1a1a] mt-1 font-sans">
              {{ __('Resource team tersedia di hampir semua kota besar, siap mendukung kebutuhan secara cepat.') }}
            </p>
          </div>
        </div>
        ...
        <div class="flex space-x-4  shadow-md p-4">
          ...
          <div>
            <h3 class="sm:text-2xl font-bold text-sm leading-snug text-[#1a1a1a]">
             {{ __('Structure Internal Team yang bisa Support Hampir setiap Activity yang berjalan') }}
            </h3>
            <p class="text-xs leading-relaxed text-[#1a1a1a] mt-1 font-sans">
             {{ __('Struktur tim internal mendukung hampir semua aktivitas, memastikan kelancaran dan efisiensi kerja.') }}
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- <div class="max-w-3xl">
   ...
   <div class="z-10 relative ">
    <div class="mb-10 flex w-full justify-between flex-wrap text-white text-[15px] text-[22px] md:text-[40px] font-semibold leading-snug">
     {{ __('Kami menyediakan berbagai layanan') }}
     <br/>
     {{ __('Strategic Marketing') }}
 ...
 <!-- ======= FAQ ======= -->
  <section data-aos="fade-up" class="w-full py-6 md:py-12" id="faq" >
    <h2 class="text-3xl sm:text-3xl md:text-4xl font-extrabold text-[#1a1a1a] md:w-1/3 leading-tight">{{ __('Pertanyaan Umum (FAQ)') }}</h2>
    <p class="text-gray-600 mb-8 mt-6">
      {{ __('Butuh bantuan? Berikut jawaban cepat untuk pertanyaan yang sering diajukan tentang layanan SPG & event kami.') }}
    </p>
    ...
    @php
        $faqs = [
            [
                'id' => 'faq1',
                'question' => __('Apa layanan yang disediakan Hanz Management?'),
                'answer' => __('Kami menyediakan SPG, SPB, usher, model, dokumentasi serta support produksi event dan dekorasi.'),
            ],
            [
                'id' => 'faq2',
                'question' => __('Brands apa saja yang bekerja sama dengan Hanz Management?'),
                'answer' => __('Gojek, Grab, Sari roti, Dana, Gopay, Omela, Mie sedap dan chocodrink <a href="#client" class="text-blue-500">View all brands</a>'),
            ],
            [
                'id' => 'faq3',
                'question' => __('Bagaimana cara memesan SPG untuk event saya?'),
                'answer' => __('Kirim brief (tanggal, lokasi, durasi, jumlah talent, tugas) via form kontak, email, atau WA. Kami akan kirim penawaran dan konfirmasi ketersediaan.'),
            ],
            [
                'id' => 'faq4',
                'question' => __('Berapa biaya / rate untuk SPG per event?'),
                'answer' => __('Rate bergantung pada durasi, lokasi, jumlah talent, dan kebutuhan khusus. Kami akan mengirimkan penawaran setelah menerima brief lengkap.'),
            ],
            [
                'id' => 'faq5',
                'question' => __('Apakah talent diberi training sebelum event?'),
                'answer' => __('Ya — talent akan mendapatkan briefing/training singkat sesuai kebutuhan brand atau tugas acara.'),
            ],
        ];
    @endphp
  ...
  <h2 class="text-3xl sm:text-3xl md:text-4xl text-center font-extrabold text-white md:w-1/3 leading-tight">
    {{ __('Proyek Kreatif Kami Bersama Brand') }}
  </h2>
  </div>
</section>
  ...
  <!-- ======= our client ======== -->
    ...
    <p class="text-black text-lg mb-6">{{ __('Dipercaya oleh tim di') }}</p>
    <div class="slider">
      @php
        $brandLogos = [
